    ...
    google.firestore = (function() {
        ...
        firestore.v1 = (function() {
            ...
            v1.Document = (function() {
                 ...
                 * @static
                 * @param {google.firestore.v1.IDocument=} [properties] Properties to set
                 * @returns {google.firestore.v1.Document} Document instance
                 */
                 ...
                 * @memberof google.firestore.v1.Document
                 * @static
                 * @param {google.firestore.v1.IDocument} message Document message or plain object to encode
                 * @param {$protobuf.Writer} [writer] Writer to encode to
                 * @returns {$protobuf.Writer} Writer
                 */
                Document.encode = function encode(message, writer) {
                    ...
                    if (message.fields != null && Object.hasOwnProperty.call(message, "fields"))
                        for (let keys = Object.keys(message.fields), i = 0; i < keys.length; ++i) {
                            ...
                            $root.google.firestore.v1.Value.encode(message.fields[keys[i]], writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim().ldelim();
                        }
                ...
                Document.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    let end = length === undefined ? reader.len : reader.pos + length, message = new $root.google.firestore.v1.Document(), key, value;
                    while (reader.pos < end) {
                        let tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1:
                        ...
                        case 2:
                            ...
                            while (reader.pos < end2) {
                                ...
                                case 1:
                                    ...
                                    break;
                                case 2:
                                    value = $root.google.firestore.v1.Value.decode(reader, reader.uint32());
                                    break;
                                default:
                                    reader.skipType(tag2 & 7);
                                    break;
                ...
                Document.verify = function verify(message) {
                    ...
                    if (message.fields != null && message.hasOwnProperty("fields")) {
                        ...
                        let key = Object.keys(message.fields);
                        for (let i = 0; i < key.length; ++i) {
                            let error = $root.google.firestore.v1.Value.verify(message.fields[key[i]]);
                            if (error)
                                return "fields." + error;
                        }
                    }
                ...
                Document.fromObject = function fromObject(object) {
                    if (object instanceof $root.google.firestore.v1.Document)
                        return object;
                    let message = new $root.google.firestore.v1.Document();
                    if (object.name != null)
                        message.name = String(object.name);
                    if (object.fields) {
                        if (typeof object.fields !== "object")
            ...
            v1.Value = (function() {
                 ...
                 * @static
                 * @param {google.firestore.v1.IValue=} [properties] Properties to set
                 * @returns {google.firestore.v1.Value} Value instance
                 */
                Value.create = function create(properties) {
                    return new Value(properties);
                };
                 ...
                 * @memberof google.firestore.v1.Value
                 * @static
                 * @param {google.firestore.v1.IValue} message Value message or plain object to encode
                 * @param {$protobuf.Writer} [writer] Writer to encode to
                 * @returns {$protobuf.Writer} Writer
                 */
                Value.encode = function encode(message, writer) {
                    ...
                    if (message.mapValue != null && Object.hasOwnProperty.call(message, "mapValue"))
                        $root.google.firestore.v1.MapValue.encode(message.mapValue, writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
                    ...
                    if (message.arrayValue != null && Object.hasOwnProperty.call(message, "arrayValue"))
                        $root.google.firestore.v1.ArrayValue.encode(message.arrayValue, writer.uint32(/* id 9, wireType 2 =*/74).fork()).ldelim();
                ...
                Value.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    let end = length === undefined ? reader.len : reader.pos + length, message = new $root.google.firestore.v1.Value();
                    while (reader.pos < end) {
                        let tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 11:
                        ...
                        case 8:
                            ...
                            break;
                        case 9:
                            message.arrayValue = $root.google.firestore.v1.ArrayValue.decode(reader, reader.uint32());
                            break;
                        case 6:
                            message.mapValue = $root.google.firestore.v1.MapValue.decode(reader, reader.uint32());
                            break;
                        default:
                            reader.skipType(tag & 7);
                            break;
                ...
                Value.verify = function verify(message) {
                    ...
                    if (message.arrayValue != null && message.hasOwnProperty("arrayValue")) {
                        ...
                        properties.valueType = 1;
                        {
                            let error = $root.google.firestore.v1.ArrayValue.verify(message.arrayValue);
                            if (error)
                    ...
                    if (message.mapValue != null && message.hasOwnProperty("mapValue")) {
                        ...
                        properties.valueType = 1;
                        {
                            let error = $root.google.firestore.v1.MapValue.verify(message.mapValue);
                            if (error)
                ...
                Value.fromObject = function fromObject(object) {
                    if (object instanceof $root.google.firestore.v1.Value)
                        return object;
                    let message = new $root.google.firestore.v1.Value();
                    switch (object.nullValue) {
                    case "NULL_VALUE":
                    case 0:
                        message.nullValue = 0;
            ...
            v1.ArrayValue = (function() {
                 ...
                 * @static
                 * @param {google.firestore.v1.IArrayValue=} [properties] Properties to set
                 * @returns {google.firestore.v1.ArrayValue} ArrayValue instance
                 */
                 ...
                 * @memberof google.firestore.v1.ArrayValue
                 * @static
                 * @param {google.firestore.v1.IArrayValue} message ArrayValue message or plain object to encode
                 * @param {$protobuf.Writer} [writer] Writer to encode to
                 * @returns {$protobuf.Writer} Writer
                 */
                ArrayValue.encode = function encode(message, writer) {
                    ...
                    if (message.values != null && message.values.length)
                        for (let i = 0; i < message.values.length; ++i)
                            $root.google.firestore.v1.Value.encode(message.values[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
                    return writer;
                };
                ...
                ArrayValue.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    let end = length === undefined ? reader.len : reader.pos + length, message = new $root.google.firestore.v1.ArrayValue();
                    while (reader.pos < end) {
                        let tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1:
                            if (!(message.values && message.values.length))
                                message.values = [];
                            message.values.push($root.google.firestore.v1.Value.decode(reader, reader.uint32()));
                            break;
                        default:
                            reader.skipType(tag & 7);
                            break;
                ...
                ArrayValue.verify = function verify(message) {
                    ...
                    if (message.values != null && message.hasOwnProperty("values")) {
                        if (!Array.isArray(message.values))
                            return "values: array expected";
                        for (let i = 0; i < message.values.length; ++i) {
                            let error = $root.google.firestore.v1.Value.verify(message.values[i]);
                            if (error)
                                return "values." + error;
                        }
                    }
                ...
                ArrayValue.fromObject = function fromObject(object) {
                    if (object instanceof $root.google.firestore.v1.ArrayValue)
                        return object;
                    let message = new $root.google.firestore.v1.ArrayValue();
                    if (object.values) {
                        if (!Array.isArray(object.values))
            ...
            v1.MapValue = (function() {
                 ...
                 * @static
                 * @param {google.firestore.v1.IMapValue=} [properties] Properties to set
                 * @returns {google.firestore.v1.MapValue} MapValue instance
                 */
                 ...
                 * @memberof google.firestore.v1.MapValue
                 * @static
                 * @param {google.firestore.v1.IMapValue} message MapValue message or plain object to encode
                 * @param {$protobuf.Writer} [writer] Writer to encode to
                 * @returns {$protobuf.Writer} Writer
                 */
                ...
                MapValue.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    let end = length === undefined ? reader.len : reader.pos + length, message = new $root.google.firestore.v1.MapValue(), key, value;
                    while (reader.pos < end) {
                        let tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1:
                ...
                MapValue.fromObject = function fromObject(object) {
                    if (object instanceof $root.google.firestore.v1.MapValue)
                        return object;
                    let message = new $root.google.firestore.v1.MapValue();
                    if (object.fields) {
                        if (typeof object.fields !== "object")
